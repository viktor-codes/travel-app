	...
	return (
		<section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
			...
			<div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
				...
				/>
				<h1 className='text-[52px] font-bold lg:text-[88px]'>
					Putuk Truno Camp Arrea
				</h1>
				...
				<div className='my-11 flex flex-wrap gap-5'>
					...
					<p className='text-base font-normal lg:text-xl lg:font-bold text-blue-70'>
						198k
						<span className='text-base lg:text-xl ml-1 '>
							Excellent Reviews
						</span>
					</p>
				</div>
			...
			<div className='relative flex-1 items-star '>
